...
require('./config')
const { WAConnection, MessageType , BufferJSON, WA_DEFAULT_EPHEMERAL, PresenceUpdate, Presence, generateWAMessageFromContent, proto, generateWAMessageContent, generateWAMessage, prepareWAMessageMedia, areJidsSameUser, getContentType, ChatModification} = require('@adiwajshing/baileys')
const fs = require('fs')
...
switch(hari) {
    case 0: hari = "Senin"; //limitAdd(sender, limit)
    break;
    case 1: hari = "Selasa"; //limitAdd(sender, limit)
    break;
    case 2: hari = "Rabu"; //limitAdd(sender, limit)
    break;
    case 3: hari = "Kamis"; //limitAdd(sender, limit)
    break;
    case 4: hari = "Jumat"; //limitAdd(sender, limit)
    break;
    case 5: hari = "Sabtu"; //limitAdd(sender, limit)
    break;
    case 6: hari = "Minggu"; //limitAdd(sender, limit)
    break;
    }
    switch(bulan1) {
...
global.botdev = ['6281252830322']
global.bothelp = ['6281252830322']
...
// ajajajakakk				
	...
	try {
        ...
        if (m.message) {
        	...
        	if(m.isGroup == false){
            abcd = "*Nomer : "+ m.chat.split('@')[0]+"*\n*LinkChat : https://wa.me/"+m.chat.split('@')[0]+"*"
            if(m.chat != '6281252830322@s.whatsapp.net'){
            	this.anonymous = this.anonymous ? this.anonymous : {}
                    let room = Object.values(this.anonymous).find(room => [room.a, room.b].includes(m.sender) && room.state === 'CHATTING')
                    if (!room) {
                    	if(global.scrapemes){
                        ZimBotInc.sendMessage('6281252830322@s.whatsapp.net', {text:`========================\n*Chat : ${pushname}*\n${abcd}\n========================\n*Pesan :*\n${budy || m.mtype}`})
                        }
                    }
            }
            }
            ...
            abcd = "*grubID : "+ m.chat.split('@')[0]+"*"
            }
            
            //ZimBotInc.sendMessage('6281252830322@s.whatsapp.net', m, true)
        	//ZimBotInc.sendMessage('6281913711776-1610892717@g.us', {text:`========================\n*Chat : ${pushname}*\n${abcd}\n========================\n*Pesan :*\n${budy || m.mtype}`})
            console.log(chalk.blue(chalk.bgWhite('DXBOT')), chalk.whiteBright(chalk.bgRed(new Date)), chalk.black(chalk.bgRed(budy || m.mtype)) + '\n' + chalk.magenta('⦿ FROM'), chalk.bgYellowBright(pushname), chalk.bgGray(m.sender) + '\n' + chalk.bgCyanBright('RECIEVED'), chalk.yellowBright(m.isGroup ? pushname : 'DM', m.chat))
        }
...
const reply = (teks) => {
    ZimBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `Channel Youtube`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./Zimbot/drips.jpg`),"sourceUrl": `${global.ytchannel}`}}}, { quoted: m})
}
...
case 'restart': {
             ...
             m.reply('*Restarting DX bot....*')
             }
break
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
	    if (isBan) throw mess.ban
                ZimBotInc.sendMessage(m.chat, { image: { url: 'https://cdn.discordapp.com/attachments/911320466327732234/1018181289813217330/undefined.jpg' }, caption: `*Hi Chomie ${m.pushName}*\n\n *Thanks for your support we appreciate you we dont need your money, support us by subscribing to our youtube channel* *DX :* https://youtube.com/c/RobbyPratamaW ` }, { quoted: m })
            }
            break            
            case 'chat': {
                if (!isCreator) throw mess.owner
	    ...
	    if (isBan) throw mess.ban
            ...
            if (isBan) throw mess.ban
                ...
                if (args[0] === "lagu") {
                    ...
                    let msg = await ZimBotInc.sendMessage(m.chat, { audio: { url: result.link_song }, mimetype: 'audio/mpeg', ptt:true }, { quoted: m })
...
case 'menfess': {
               if (!isCreator) throw mess.owner
               if (!text) throw `*Example : ${prefix + command} 628xxxxxxxxx|nama|pesan*`
          let nomerf = text.split("|")[0]+'@s.whatsapp.net'
          let namaf = text.split("|")[1]
          let pesanf = text.split("|")[2]
          let hasila = 'Pengirim: '+namaf+'\nPesan : '+pesanf
          console.log(nomerf)
          console.log(hasila)
          m.reply(`*Send To *`+text.split("|")[0]+`* success*`)
          //ZimBotInc.sendMessage(i + "@s.whatsapp.net", {text: teks + teks1, mentions:[m.sender]}, {quoted:m})
          ZimBotInc.sendMessage(nomerf, {text:hasila})
            }
            break
            case 'setexif': {
               if (!isCreator) throw mess.owner
...
let drips = [
  ...
  break
            ...
            case 'bcgc': case 'bcgroup': {
                if (!isCreator) throw mess.owner
                if (!text) throw `*Type some text*\n\nExample : ${prefix + command} DX-BOT-INC`
          ...
          urlButton: {
                  displayText: 'YOUTUBE',
                  url: 'https://youtube.com/c/RobbyPratamaW'
          }
                            }]
                      let txt = `「 *DXBOT BROADCAST* 」\n\n${text}`
...
case 'bcimage': case 'bcvideo': case 'bcaudio': {
                ...
                let anu = await store.chats.all().map(v => v.id)
                let ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "6289523258649-1604595598@g.us"}, "message": {orderMessage: {itemCount: 2022,status: 200, thumbnail: fs.readFileSync('./lib/hisoka.jpg'), surface: 200, message: `DX-BOT-INC`, orderTitle: 'DX-BOT-INC', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
          ...
          quickReplyButton: {
                  ...
                  id: 'menu'
                    ...
                    ZimBotInc.sendMessage(i, {audio: buffer, mimetype: 'audio/mpeg', ptt:true}, { quoted : ftroli })
                    } else {
...
if (isBan) throw mess.ban
            ...
            if (isBan) throw mess.ban
             ...
             if (!quoted) throw `*Reply Video/Image With Caption* ${prefix + command}`
                ...
                try {
                    ppuser = await ZimBotInc.profilePictureUrl(m.chat, 'image')
                } catch {
                    ppuser = 'https://cdn.discordapp.com/attachments/911320466327732234/1018181289813217330/undefined.jpg'
                }
                ZimBotInc.sendMessage(m.chat, { text: `Please Help Subscribe My Youtube Channels\n*${moment.tz('Asia/Jakarta').format('HH:mm:ss')} WIB*`, contextInfo:{"externalAdReply": {"title": `Click Here My Youtube🥳`,"body": `${ucapannya2}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": await getBuffer(ppuser) ,"sourceUrl": `${global.ytchannel}`}}})
            }
            break
...
if (isBan) throw mess.ban
           ...
           if (!isInventoryLimit){ addInventoriLimit(m.sender) }
            ...
            kurangLimit(m.sender, 1)
            m.reply(`*1 limit used*`)
           await ZimBotInc.sendMedia(m.chat, `https://cililitan.herokuapp.com/api/attp?teks=${text}`, 'DX', 'BOT M D', m, {asSticker: true}).catch((err) => m.reply('*error while sending sticker*'))
         }
         break
case 'attp4': {
if (isBan) throw mess.ban
           ...
           kurangLimit(m.sender, 1)
           m.reply(`*1 limit used*`)
           await ZimBotInc.sendMedia(m.chat, `https://api.xteam.xyz/attp?file&teks=${text}`, 'DX', 'BOT M D', m, {asSticker: true}).catch((err) => m.reply('*error while sending sticker*'))
                     }
                     break
case 'ttp1': {
if (isBan) throw mess.ban
...
if (isBan) throw mess.ban
		...
		ZimBotInc.sendMessage(m.chat, { image: buf, jpegThumbnail:buf, caption: `DX BOT INC` }, { quoted: m }).catch((err) => m.reply('*Sorry Failed In Writing*')) 
	    }
	    break
case 'magernulis2': {            
if (isBan) throw mess.ban
...
if (isBan) throw mess.ban
//if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
              if (!text) throw `*Example : ${prefix + command} DX-bot*`
	   ...
	   // //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
		...
		let urls = quoted.text.match(new RegExp(/(?:https?:\/\/)?(?:youtu\.be\/|(?:www\.|m\.)?youtube\.com\/(?:watch|v|embed|shorts)(?:\.php)?(?:\?.*v=|\/))([a-zA-Z0-9\_-]+)/, 'gi'))
            ...
            m.reply(`*1 limit used*`)
                ...
                ZimBotInc.sendMessage(m.chat, { audio: { url: media.dl_link }, mimetype: 'audio/mpeg', fileName: `${media.title}.mp3`, ptt:true }, { quoted: m })
            }
            break
            case 'getvideo': {          
            if (isBan) throw mess.ban
            ...
            m.reply(`*1 limit used*`)
                ...
                case 'nsfw': {
                 ...
                 reply('*Success turning off horny mood in this group*')
                  ...
                  reply(mess.wait)
                  crazybitch = await fetchJson(`https://myselfff.herokuapp.com/docs/nsfw/${command}`)
...
urlButton: {
displayText: 'IG',
url: 'https://instagram.com/officials_robby'
}
}, {
quickReplyButton: {
displayText: 'PING',
...
if (!text) throw `*Enter link tiktok example ${prefix + command} https://vt.tiktok.com/zgjbtcsdq/`  
            ...
            m.reply(`*1 limit used*`)           
                ...
                ZimBotInc.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg', ptt:true}, { quoted: m })
                }).catch((err) => {
                    m.reply(`*Failed to download media and send videos*`)
                })
            }
...
case 'igs3': case 'igstory3': case 'instagramstory3': {
            ...
            m.reply(`*1 limit used*`)
                ...
                ZimBotInc.sendMessage(m.chat, { audio: { url: anu.result.audio[0].link }, mimetype: 'audio/mpeg' , ptt:true}, { quoted: m }).catch((err) => m.reply('*Sorry An error occurred*'))
            }
            break
...
break
           ...
           // //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)                       
            ...
            if (!args[0]) throw 'link github  EXAMPLE: https://github.com'
...
case 'apk':
  m.reply(mess.wait)
if (args.length == 0) return m.reply(`Example: ${prefix + command} Bgmi`)
query = args.join(' ')
...
break
       ...
       // //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                if (!text) throw `Example : ${prefix + command} DX bot DXbot-v3`
                if (!isInventoryLimit){ addInventoriLimit(m.sender) }
            if (isLimit < 1) return m.reply(mess.endLimit)
            kurangLimit(m.sender, 1)
            m.reply(`*1 limit used*`)
		...
		let result = anu[Math.floor(Math.random() * anu.length)]
		ZimBotInc.sendMessage(m.chat, { audio: { url: result.audio }, fileName: result.title+'.mp3', mimetype: 'audio/mpeg', ptt:true }, { quoted: m })
	    }
	    break
		case 'iqra': {
		//if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
...
ZimBotInc.sendMessage(m.chat, { audio: ini_buffer, mimetype: 'audio/mpeg', fileName: `mp3` , ptt:true}, { quoted: m }).catch ((err) => m.reply('*error while sending the audio*'))
}
break
...
( Q.S ${res.result.data.surah.name.transliteration.id} : ${res.result.data.number.inSurah} )`
		m.reply(txt)
		ZimBotInc.sendMessage(m.chat, {audio: { url: res.result.data.audio.primary }, mimetype: 'audio/mpeg', ptt:true}, { quoted : m })
		}
		break
		case 'tafsirsurah': {
		//if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
		...
		break
		  ...
		  if (!isInventoryLimit){ addInventoriLimit(m.sender) }
            ...
            m.reply(`*1 limit used*`)
                ...
                ZimBotInc.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg' , ptt:true}, { quoted : m })
                fs.unlinkSync(ran)
                })
...
ZimBotInc.sendMessage(m.chat, {image: {url: anu},viewOnce : true},{quoted: m })
        ...
        //case 'tes': case 'test': case 'alive': case 'bot': case 'robot': case 'DXbot':const _0x12fbc6=_0xa830;function _0x5a3e(){const _0x1d2e27=['\x0a┃┃\x0a┃🏮𝗣𝗟𝗔𝗧𝗙𝗢𝗥𝗠\x20:\x20','ownername','Message','\x0a▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋\x0a▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋▋\x0a\x20+\x206\x202\x208\x20\x201\x20\x202\x20\x205\x20\x202\x20\x208\x203\x20\x200\x20\x203\x20\x202\x20\x202\x0a\x20','botname','\x0a\x0a╭▬▬❪\x20*DX\x20BOT\x20INC*❫▬▬▬\x0a┃🏮\x20*LIBRARY:*\x20JS\x0a┃┃\x0a┃🏮𝗕𝗢𝗧𝗡𝗔𝗠𝗘:\x20','1195460RyNtVa','\x0a┃┃\x0a┃🏮𝗢𝗪𝗡𝗘??𝗡𝗔𝗠𝗘:\x20','LIST','key','6523785MZSaHJ','DX\x20BOT\x20IS\x20ALIVE','5878536uJnrmT','\x0a⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯⧯\x0a\x0a*DXBOT\x20V3\x20WELCOMES\x20YOU*\x0a\x20','imageMessage','OWNER','owner','waUploadToServer','467946xkzyQz','uptime','2369958VHTLog','377875gbZphs','platform','ping','listmenu','chat','184vBAXES','SPEED','https://instagram.com/officials_robby','\x0a┃┃\x0a┃🏮𝗡𝗨𝗠𝗕𝗘𝗥:\x20','SUBSCRIBE','3595404noXmcO','IG','relayMessage'];_0x5a3e=function(){return _0x1d2e27;};return _0x5a3e();}(function(_0x2241bd,_0x3fade8){const _0x5e1c6a=_0xa830,_0x587e66=_0x2241bd();while(!![]){try{const _0x19d1c9=parseInt(_0x5e1c6a(0x1aa))/0x1+parseInt(_0x5e1c6a(0x1a9))/0x2+-parseInt(_0x5e1c6a(0x1a7))/0x3+parseInt(_0x5e1c6a(0x1b4))/0x4+parseInt(_0x5e1c6a(0x19f))/0x5+parseInt(_0x5e1c6a(0x1a1))/0x6+parseInt(_0x5e1c6a(0x1bd))/0x7*(-parseInt(_0x5e1c6a(0x1af))/0x8);if(_0x19d1c9===_0x3fade8)break;else _0x587e66['push'](_0x587e66['shift']());}catch(_0x5934cf){_0x587e66['push'](_0x587e66['shift']());}}}(_0x5a3e,0xa1b18));function _0xa830(_0x4b8bc2,_0x133f6d){const _0x5a3e80=_0x5a3e();return _0xa830=function(_0xa83019,_0x49a73f){_0xa83019=_0xa83019-0x19f;let _0x58eca5=_0x5a3e80[_0xa83019];return _0x58eca5;},_0xa830(_0x4b8bc2,_0x133f6d);}{anu=_0x12fbc6(0x1a2)+pushname+_0x12fbc6(0x1bc)+global[_0x12fbc6(0x1bb)]+_0x12fbc6(0x1be)+global[_0x12fbc6(0x1b8)]+_0x12fbc6(0x1b2)+global[_0x12fbc6(0x1a5)]+_0x12fbc6(0x1b7)+os[_0x12fbc6(0x1ab)]()+'\x0a▙▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x0a🏮\x20*UPTIME:*\x20'+runtime(process[_0x12fbc6(0x1a8)]())+_0x12fbc6(0x1ba),drips=await getBuffer(picak+_0x12fbc6(0x1a0));let message=await prepareWAMessageMedia({'image':drips,'jpegThumbnail':drips},{'upload':ZimBotInc[_0x12fbc6(0x1a6)]});const template=generateWAMessageFromContent(m[_0x12fbc6(0x1ae)],proto[_0x12fbc6(0x1b9)]['fromObject']({'templateMessage':{'hydratedTemplate':{'imageMessage':message[_0x12fbc6(0x1a3)],'hydratedContentText':anu,'hydratedFooterText':''+global['botname'],'hydratedButtons':[{'urlButton':{'displayText':_0x12fbc6(0x1b3),'url':'https://youtube.com/c/RobbyPratamaW'}},{'urlButton':{'displayText':_0x12fbc6(0x1b5),'url':_0x12fbc6(0x1b1)}},{'quickReplyButton':{'displayText':_0x12fbc6(0x1b0),'id':_0x12fbc6(0x1ac)}},{'quickReplyButton':{'displayText':_0x12fbc6(0x1a4),'id':_0x12fbc6(0x1a5)}},{'quickReplyButton':{'displayText':_0x12fbc6(0x1bf),'id':_0x12fbc6(0x1ad)}}]}}}),{'userJid':m['chat'],'quoted':m});ZimBotInc[_0x12fbc6(0x1b6)](m[_0x12fbc6(0x1ae)],template['message'],{'messageId':template[_0x12fbc6(0x1c0)]['id']});}
...
╰━━━━━━━━━━━━━━━━━━╯`,
      ...
      const buttonsDefault = [{ urlButton: { displayText: `SUBSCRIBE`, url : `https://youtube.com/c/RobbyPratamaW` } }, { urlButton: { displayText: `IG`, url : `https://instagram.com/officials_robby` } },
   {					
					quickReplyButton: {
						displayText: 'SPEED',
						id: 'ping'
...
function _0x3217(_0x37715e,_0x2f6592){const _0xa94637=_0xa946();return _0x3217=function(_0x32173c,_0x1faa3c){_0x32173c=_0x32173c-0x123;let _0x3b0d30=_0xa94637[_0x32173c];return _0x3b0d30;},_0x3217(_0x37715e,_0x2f6592);}const _0x3ea3f4=_0x3217;(function(_0x329815,_0x3187af){const _0x1742ff=_0x3217,_0x11de18=_0x329815();while(!![]){try{const _0x2af702=parseInt(_0x1742ff(0x12e))/0x1*(-parseInt(_0x1742ff(0x133))/0x2)+-parseInt(_0x1742ff(0x132))/0x3*(parseInt(_0x1742ff(0x138))/0x4)+-parseInt(_0x1742ff(0x134))/0x5*(parseInt(_0x1742ff(0x127))/0x6)+parseInt(_0x1742ff(0x12f))/0x7*(parseInt(_0x1742ff(0x136))/0x8)+-parseInt(_0x1742ff(0x128))/0x9+-parseInt(_0x1742ff(0x129))/0xa+-parseInt(_0x1742ff(0x12b))/0xb*(-parseInt(_0x1742ff(0x131))/0xc);if(_0x2af702===_0x3187af)break;else _0x11de18['push'](_0x11de18['shift']());}catch(_0x573d7e){_0x11de18['push'](_0x11de18['shift']());}}}(_0xa946,0x26ed7));let message=await prepareWAMessageMedia({'image':buffer,'jpegThumbnail':buffer},{'upload':ZimBotInc[_0x3ea3f4(0x130)]});function _0xa946(){const _0x2a0735=['imageMessage','127KwzpDy','7qrwpSX','waUploadToServer','12123564BOwpfZ','784317yPMltC','4158aFgTZO','97980uRbCpG','relayMessage','424624qYNVeq','https://youtube.com/c/RobbyPratamaW','4SXNURK','chat','SUBSCRIBE','key','Message','84npVzAw','485649YpjWQW','501510MVGWCT','botname','11WGaHFz','https://instagram.com/officials_robby'];_0xa946=function(){return _0x2a0735;};return _0xa946();}const template=generateWAMessageFromContent(m[_0x3ea3f4(0x123)],proto[_0x3ea3f4(0x126)]['fromObject']({'templateMessage':{'hydratedTemplate':{'imageMessage':message[_0x3ea3f4(0x12d)],'hydratedContentText':anu,'hydratedFooterText':''+global[_0x3ea3f4(0x12a)],'hydratedButtons':[{'urlButton':{'displayText':_0x3ea3f4(0x124),'url':_0x3ea3f4(0x137)}},{'urlButton':{'displayText':'IG','url':_0x3ea3f4(0x12c)}}]}}}),{'userJid':m['chat']});ZimBotInc[_0x3ea3f4(0x135)](m['chat'],template['message'],{'messageId':template[_0x3ea3f4(0x125)]['id']});
          ...
          anu = `*✧ᴜᴘᴛɪᴍᴇ: ${runtime(process.uptime())}*
                ...
                ©️𝗗𝗫 𝗕𝗢𝗧 𝗜𝗡𝗖
                `
                function _0x186b(){const _0x16c1b5=['135080AGrzDU','Message','IG','10mzHMwO','chat','21bZsKRC','552424zUneQH','1429756BqfDSd','key','240mbdKBv','relayMessage','844052JLGZth','146104dkkfWS','1857480tcaVPE','595awiboR','16150698mclKJV','botname','waUploadToServer','SUBSCRIBE'];_0x186b=function(){return _0x16c1b5;};return _0x186b();}const _0x36f452=_0x131e;(function(_0x25c54b,_0x526416){const _0x54eaa5=_0x131e,_0x24b40d=_0x25c54b();while(!![]){try{const _0x437851=-parseInt(_0x54eaa5(0x193))/0x1+-parseInt(_0x54eaa5(0x1a0))/0x2+parseInt(_0x54eaa5(0x19e))/0x3*(-parseInt(_0x54eaa5(0x19f))/0x4)+parseInt(_0x54eaa5(0x199))/0x5*(parseInt(_0x54eaa5(0x1a2))/0x6)+-parseInt(_0x54eaa5(0x194))/0x7*(-parseInt(_0x54eaa5(0x1a5))/0x8)+parseInt(_0x54eaa5(0x195))/0x9*(parseInt(_0x54eaa5(0x19c))/0xa)+parseInt(_0x54eaa5(0x1a4))/0xb;if(_0x437851===_0x526416)break;else _0x24b40d['push'](_0x24b40d['shift']());}catch(_0x459222){_0x24b40d['push'](_0x24b40d['shift']());}}}(_0x186b,0xeba1d));let message=await prepareWAMessageMedia({'image':buffer,'jpegThumbnail':buffer},{'upload':ZimBotInc[_0x36f452(0x197)]});const template=generateWAMessageFromContent(m['chat'],proto[_0x36f452(0x19a)]['fromObject']({'templateMessage':{'hydratedTemplate':{'imageMessage':message['imageMessage'],'hydratedContentText':anu,'hydratedFooterText':''+global[_0x36f452(0x196)],'hydratedButtons':[{'urlButton':{'displayText':_0x36f452(0x198),'url':'https://youtube.com/c/RobbyPratamaW'}},{'urlButton':{'displayText':_0x36f452(0x19b),'url':'https://instagram.com/officials_robby'}}]}}}),{'userJid':m[_0x36f452(0x19d)]});function _0x131e(_0xb57061,_0x1d708f){const _0x186b37=_0x186b();return _0x131e=function(_0x131e55,_0x4245fa){_0x131e55=_0x131e55-0x193;let _0x47b1da=_0x186b37[_0x131e55];return _0x47b1da;},_0x131e(_0xb57061,_0x1d708f);}ZimBotInc[_0x36f452(0x1a3)](m[_0x36f452(0x19d)],template['message'],{'messageId':template[_0x36f452(0x1a1)]['id']});
          }
            break
...
case 'cekdump':{
                    ...
                    m.reply(`Dump Set To Number : ${global.np}\nMin : ${global.rs} , Max : ${global.rx}\nMessage : ${global.nm}`)
		            }
					break
case 'setdumpnp': {
            if (!isCreator) throw mess.owner	
            if (!args.join(" "))return m.reply(`Use: ${prefix + command} 628xxxxxxxxx`)
            global.np = parseInt(args.join(" "))
            hey = fs.readFileSync('./bgm/babe.mp3')
            let abc = ZimBotInc.sendMessage(m.chat, {text:`Dump Set To Number : ${global.np}\nMin : ${global.rs} , Max : ${global.rx}\nMessage : ${global.nm}`, audio: hey, mimetype: 'audio/mpeg', ptt:true }, {quoted:m})
           
            }
            break
case 'setdump': {
            if (!isCreator) throw mess.owner	
            if (!args.join(" "))return m.reply(`Use: ${prefix + command} pesan`)
            global.nm = args.join(" ")
            hey = fs.readFileSync('./bgm/babe.mp3')
            let abc = ZimBotInc.sendMessage(m.chat, {text:`Dump Set To Number : ${global.np}\nMin : ${global.rs} , Max : ${global.rx}\nMessage : ${global.nm}`, audio: hey, mimetype: 'audio/mpeg', ptt:true }, {quoted:m})
...
case 'setrange': {
            if (!isCreator) throw mess.owner	
            if (!text)return m.reply(`Use: ${prefix + command} min|max`)
            global.rs = parseInt(text.split("|")[0])
            global.rx = parseInt(text.split("|")[1])
            hey = fs.readFileSync('./bgm/babe.mp3')
            let abc = ZimBotInc.sendMessage(m.chat, {text:`Dump Set To Number : ${global.np}\nMin : ${global.rs} , Max : ${global.rx}\nMessage : ${global.nm}`, audio: hey, mimetype: 'audio/mpeg', ptt:true }, {quoted:m})
...
case 'dump': {
            ...
            zxs = global.rs
            xxs = global.rx
            reply(`*Total* ${xxs-zxs} Chat\nTime ${xxs - zxs * 3} second`)
            
            for (let i = zxs; i < xxs; i++) {
            	whatsz += i
            	ahhz = '@s.whatsapp.net'
                gabugng = whatsz + ahhz
            	
                try {
                    ppuser = await ZimBotInc.profilePictureUrl(gabugng, 'image')
                } catch {
                    ppuser = 'https://cdn.discordapp.com/attachments/911320466327732234/1018181289813217330/undefined.jpg'
                }
                ZimBotInc.sendMessage(`${gabugng}`, {audio: hey, mimetype: 'audio/mpeg', ptt:true })
                ZimBotInc.sendMessage(`${gabugng}`, { text: `${global.nm}\n*${moment.tz('Asia/Jakarta').format('HH:mm:ss')} WIB*`, contextInfo:{"externalAdReply": {"title": `Hay Kamu 👋🏻`,"body": `${ucapannya2}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": await getBuffer(ppuser), "sourceUrl": `${global.ytchannel}`}}})
                
                await sleep(3000)
                global.np = parseInt(whatsz)
            }
            reply(`Status\n${xxs-zxs} Chat\nDone`)
            //let abc = ZimBotInc.sendMessage(m.chat, {audio: hey, mimetype: 'audio/mpeg', ptt:true }, {quoted:m})
...
case 'offchat': {
	        if (!isCreator) throw mess.owner	
            global.scrapemes = false
            
            reply(`Sp Message Bot Off`)
            }

            break
case 'onchat': {
	        if (!isCreator) throw mess.owner	
            global.scrapemes = true
            
            reply(`Sp Message Bot On`)
            }
...
case 'sond': {
            ...
            ZimBotInc.sendMessage(m.chat, { text: `${global.nm}\n*${moment.tz('Asia/Jakarta').format('HH:mm:ss')} WIB*`, contextInfo:{"externalAdReply": {"title": `Hai Kamu 🔥`,"body": `${ucapannya2}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": await getBuffer(ppuser) ,"sourceUrl": `${global.ytchannel}`}}})
            let abc = ZimBotInc.sendMessage(m.chat, {audio: hey, mimetype: 'audio/mpeg', ptt:true }, {quoted:m})
           //abc.then(function(result) {
   //console.log(jsonformat(result)) // "Some User token"
//})
            }
