...
case 'dump': {
            ...
            zxs = global.rs
            xxs = global.rx
            reply(`*Total * ${xxs-zxs} Chat\nTime ${xxsc - zxs * 3} second`)
            pesan_i = `╭━━━━━━━━━━━━━━━━━━╮\n┃      *${ucapannya2}*\n┃━━━━━━━━━━━━━━━━━━┃\n${global.nm}\n┃━━━━━━━━━━━━━━━━━━┃\n┃               *${moment.tz('Asia/Jakarta').format('HH:mm:ss')}*\n╰━━━━━━━━━━━━━━━━━━╯`
            for (let i = zxs; i < xxs; i++) {
            	whatsz += i
            	ahhz = '@s.whatsapp.net'
                gabugng = whatsz + ahhz
            	let abc = ZimBotInc.sendMessage(`${gabugng}`, {text:`${pesan_i}`, audio: hey, mimetype: 'audio/mpeg', ptt:true })
                //ZimBotInc.sendMessage(`${gabugng}`, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `Channel Youtube`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./Zimbot/drips.jpg`),"sourceUrl": `${global.ytchannel}`}}})
                await sleep(3000)
