...
case 'menfess': {
               if (!isCreator) throw mess.owner
               if (!text) throw `*Example : ${prefix + command} 62812121212223|nama|pesan*`
