...
//
require('./config')
const { default: ZimBotIncConnect, useSingleFileAuthState, DisconnectReason, fetchLatestBaileysVersion, generateForwardMessageContent, prepareWAMessageMedia, generateWAMessageFromContent, generateMessageID, downloadContentFromMessage, makeInMemoryStore, jidDecode, proto , ChatModification} = require("@adiwajshing/baileys")
...
async function startZimBotInc() {
    const ZimBotInc = ZimBotIncConnect({
        ...
        browser: ['DX BOT INC','Safari','1.0.0'],
        auth: state
    })
    ...
    ZimBotInc.sendMessage(callerId, { text: `*Jangan Telpon Saya!*\n*Saya Sedang Sibuk.*`})
    await sleep(10000)
...
ZimBotInc.sendMessage(anu.id, buttonMessage, {quoted:fgclink})
	...
	for (let i of kon) {
	    list.push({
	    	...
	    	vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await ZimBotInc.getName(i + '@s.whatsapp.net')}\nFN:${await ZimBotInc.getName(i + '@s.whatsapp.net')}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:DX\nitem2.EMAIL;type=INTERNET:officialsrobbypw@gmail.com\nitem2.X-ABLabel:Email\nitem3.URL:https://instagram.com/officials_robby/\nitem3.X-ABLabel:Instagram\nitem4.ADR:Banyuwangi\nitem4.X-ABLabel:Region\nEND:VCARD`
	    })
	}
